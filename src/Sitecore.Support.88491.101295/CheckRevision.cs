...
{
  public class CheckRevision : Sitecore.Support.ExperienceEditor.Speak.Server.Requests.PipelineProcessorRequest<PageContext>
  {
    public override PipelineProcessorResponseValue ProcessRequest()
    {
      ...
      if (item != null)
      {
        string text = ((BaseItem)item)[FieldIDs.Revision].Replace("-", string.Empty);
